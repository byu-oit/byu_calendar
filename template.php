...
//  // drupal_add_js('http://ie7-js.googlecode.com/svn/version/2.1(beta4)/IE7.js', 'external');
  drupal_add_css('//cdn.byu.edu/theme-fonts/1.x.x/ringside/fonts.css', array('type' => 'external'));

  drupal_add_css('//cdn.byu.edu/byu-theme-components/1.x.x/byu-theme-components.min.css', array('type' => 'external'));
//  drupal_add_css('//cdn.byu.edu/byu-theme-components/experimental/mobile-footer/byu-theme-components.min.css', array('type' => 'external'));
  drupal_add_js('//cdn.byu.edu/byu-theme-components/1.x.x/byu-theme-components.min.js', 'external');
