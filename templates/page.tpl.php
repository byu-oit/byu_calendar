        ...
        <nav class="top-bar"<?php print $top_bar_options; ?>>
          <div id="top-bar-inner">  
			  ...
			  <div id="top-right-inner">
				  ...
				  <div class="sign-out for-admin-pages"><a href="/caslogout">Sign Out <i class="fa fa-user" aria-hidden="true"></i></a></div>
				  <div class="sign-out not-for-admin-pages"><a href="../caslogout">Sign Out <i class="fa fa-user" aria-hidden="true"></i></a></div>
			</div>
